...
<body>
	...
	<a href="upUpdate.jsp"><input type = "button" name="pay" class="up-btn"  value ="Update Profile" ></a>
	<a href="insertPay.jsp"> <input type="button" name="pay" class="pay-btn" value="Add payment method "></a>
